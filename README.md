...
**models**
This is where your app's models will live. Each model has a directory which will contain the `recoil` model(with interface) file, and any other supporting files like actions, types, etc.
